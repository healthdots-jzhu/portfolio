...
1. During agent mode, always make the recommended changes automatically unless instructed otherwise.
2. Always ensure the code compiles and passes all tests after making changes.
3. Always make the relevant changes in both frontend and backend if applicable.
4. If the request does not follow best practices, suggest improvements.
